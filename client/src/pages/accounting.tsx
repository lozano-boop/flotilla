...
export default function Accounting() {
  ...
  if (isLoading) {
    return (
      <>
        <Header title="Contabilidad" subtitle="Control de gastos e ingresos" />
        <div className="p-6">
          <div className="text-center">Cargando registros contables...</div>
        </div>
      </>
    );
  }
      ...
      <div className="p-6 overflow-y-auto h-full">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-800">Registro de Gastos</h3>
